...
<strong>See also:</strong>[How to use the Web Report Designer in JavaScript](https://github.com/DevExpress-Examples/Reporting_how-to-use-the-web-report-designer-in-javascript-t561230)
<br/>
